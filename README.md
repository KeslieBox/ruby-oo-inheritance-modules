...
Guess what?? There is!! We're going to refactor the two modules 
...
*Note: remember to require the `fancy_dance.rb` file inside the 
...
That's it! Now that we are familiar with several methods 
